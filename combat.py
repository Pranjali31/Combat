...
def start():
    print("You attack the lion and guess what...")
    ...
    if (r1 == "Lion attacks you"):
        ...
        if (c4 == "y"):
            ...
            time.sleep(2)
            print("Hoorey! You save your pet  (press enter)")
            input()
            print("You won!!!")
            time.sleep(2)
            ...
            time.sleep(1)
            print("https://github.com/Pranjali31/Combat")
            exit()
            ...
            time.sleep(2)
            print("The lion dragged your pet away ")
            time.sleep(1)
